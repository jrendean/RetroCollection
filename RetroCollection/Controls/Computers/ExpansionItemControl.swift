    ...
    static var previews: some View {
        Group {
            StatefulPreviewWrapper(
                testData: EditorConfig<ExpansionCard>(data: ComputerCollectionItem.testData[1].expansions[1], mode: .view))

            StatefulPreviewWrapper(
                testData: EditorConfig<ExpansionCard>(data: ComputerCollectionItem.testData[1].expansions[1], mode: .edit))
        }
    }
}
#endif
